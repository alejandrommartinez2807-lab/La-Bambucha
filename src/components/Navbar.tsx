      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="fixed left-4 right-4 top-[88px] z-40 rounded-3xl border border-white/10 bg-zinc-950/95 p-4 text-white shadow-2xl shadow-black/60 backdrop-blur-xl md:hidden"
          >
