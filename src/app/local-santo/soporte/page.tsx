// DESTINO REAL: src/app/local-santo/soporte/page.tsx
// Copia todo este contenido y reemplaza el archivo indicado.
// Si Windows muestra .ts como audio, es normal: .ts también significa TypeScript.
      ...
      <div className="mx-auto max-w-7xl">
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-4 text-xs font-black uppercase tracking-[0.32em] text-[#a00000]">
                  {status?.business.name || "Santo Perrito"}
                </p>
        ...
        <section className="mt-4 grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
          ...
          >
            ...
            <div className="mt-4 rounded-2xl border-2 border-[#a00000]/20 bg-white p-4">
            ...
            <button
              ...
              className="mt-4 flex w-full items-center justify-center gap-3 rounded-full border-2 border-[#a00000] bg-yellow-300 px-6 py-4 text-sm font-black uppercase tracking-[0.12em] text-[#4a0000] disabled:opacity-50"
            >
        ...
        <section className="mt-4">
          ...
          >
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <ChecklistItem text="Google Sheets conectado y respondiendo." />
              ...
              <ChecklistItem text="La página pública no muestra textos de prueba, demo ni proveedor." />
...
function MetricCard({
  ...
  return (
    <div className={`rounded-[1.2rem] border-2 px-4 py-3 ${toneClass}`}>
      ...
      <p className="mt-1 break-words text-xl font-black text-[#220000]">
        {value}
      </p>
    </div>
  )
  ...
  return (
    <button
      ...
      className={`rounded-[1.2rem] border-2 p-4 text-left transition ${
        active
          ? "border-[#a00000] bg-yellow-300 text-[#4a0000]"
          : "border-[#a00000]/25 bg-white text-[#220000] hover:border-[#a00000]"
      }`}
    >
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <span
          className={`shrink-0 rounded-full px-3 py-1 text-[0.62rem] font-black uppercase ${
            included ? "bg-green-500 text-white" : "bg-[#220000] text-white"
          }`}
        >
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        <span className="rounded-full border border-[#a00000]/20 bg-white px-3 py-1 text-[0.62rem] font-black uppercase tracking-[0.1em] text-[#a00000]">
          Desde {moduleItem.minimumPlanLabel}
        </span>
        {moduleItem.comingSoon && (
          <span className="rounded-full border border-yellow-500/50 bg-yellow-100 px-3 py-1 text-[0.62rem] font-black uppercase tracking-[0.1em] text-[#8a5a00]">
            Próximamente
          </span>
        )}
      </div>
      ...
      {moduleItem.moduleKey === "menuProducts" && (
        <p className="mt-3 rounded-2xl border border-[#a00000]/15 bg-white px-3 py-2 text-xs font-bold leading-5 text-[#3a0000]/65">
      ...
      {canToggle ? (
        ...
        <p className="mt-4 rounded-2xl border border-[#a00000]/15 bg-white px-3 py-2 text-xs font-bold leading-5 text-[#3a0000]/65">
          {moduleItem.moduleKey === "support"
    ...
    >
      <div className="flex gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-sm font-bold leading-5 text-[#3a0000]/70">
...
function ConfigRow({ label, ok }: { label: string; ok: boolean }) {
  return (
    <div className="flex items-center justify-between gap-3 rounded-2xl border border-[#a00000]/15 bg-[#fff7e8] px-4 py-3">
      <div className="flex items-center gap-2">
        <KeyRound size={16} className="text-[#a00000]" />
        <p className="text-sm font-black uppercase text-[#220000]">
          {label}
        </p>
      </div>
...
function ChecklistItem({ text }: { text: string }) {
  return (
    <div className="flex gap-3 rounded-2xl border border-[#a00000]/15 bg-[#fff7e8] p-4">
      <AlertTriangle className="mt-0.5 shrink-0 text-[#a00000]" size={18} />
