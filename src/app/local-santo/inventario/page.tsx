...
const INVENTORY_QUICK_ITEMS_STORAGE_KEY = "la_bambucha_premium_inventory_quick_items_v1"
...
function getInventoryMovementTone(movement: InventoryMovement) {
  ...
  return "border-yellow-400 bg-yellow-100 text-[#8a5a00]"
}
...
async function readApiResponse(response: Response) {
  ...
  try {
    ...
    throw new Error("El servidor no devolvió datos válidos. Revisa el Apps Script y vuelve a intentar.")
  }
}
...
export default function InventoryPage() {
  ...
  async function copyInventoryMovementSummary() {
    ...
    const textToCopy = [
      "HISTORIAL DE INVENTARIO - LA BAMBUCHA",
  ...
  return (
    <main className="min-h-screen bg-[#fff7e8] px-3 py-4 text-[#220000] sm:px-6 lg:px-8">
      {isResetInventoryOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#220000]/55 px-4 py-6 backdrop-blur-sm">
          <div className="w-full max-w-xl overflow-hidden rounded-[1.6rem] border-4 border-red-700 bg-white shadow-2xl">
            ...
            <div className="p-5">
              ...
              <h2 className="mt-2 text-2xl font-black uppercase leading-tight text-[#a00000]">
                Reiniciar cantidades a cero
              </h2>
              <p className="mt-3 text-sm font-bold leading-6 text-[#3a0000]/75">
              ...
              <div className="mt-4 rounded-2xl border-2 border-yellow-400 bg-yellow-100 px-4 py-3 text-sm font-black leading-6 text-[#8a5a00]">
                No borra recetas ni elimina productos. Sirve para empezar un conteo físico desde cero sin perder configuración.
              </div>

              <label className="mt-5 block text-xs font-black uppercase tracking-[0.18em] text-[#a00000]">
              ...
              <input
                ...
                className="mt-2 w-full rounded-2xl border-2 border-[#a00000]/25 bg-[#fff7e8] px-4 py-4 text-base font-black uppercase text-[#4a0000] outline-none focus:border-[#a00000]"
              />
              ...
              <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:justify-end">
                <button
                  ...
                  className="rounded-2xl border-2 border-[#a00000] bg-white px-5 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#a00000] disabled:opacity-50"
                >
                  Cancelar
                </button>
                <button
      ...
      <div className="mx-auto max-w-7xl">
        ...
        {!canUseInventory && (
          <section className="mt-4 rounded-[1.5rem] border-2 border-yellow-400 bg-yellow-100 p-4">
        ...
        {canUseInventory && (
          <>
            <section className="sticky top-0 z-40 mt-4 rounded-[1.4rem] border-2 border-[#a00000] bg-white p-3 shadow-[0_8px_0_rgba(160,0,0,0.12)]">
              ...
              <div id="inventario-modulo-activo" className="mt-3 rounded-[1.1rem] border-2 border-[#a00000]/15 bg-[#fff7e8] px-4 py-3">
                <p className="text-[0.62rem] font-black uppercase tracking-[0.18em] text-[#a00000]">
                  Vista actual
                </p>
                <p className="mt-1 text-sm font-black text-[#220000]">
            ...
            <section id="inventario-alertas" className="scroll-mt-28 mt-4 rounded-[1.5rem] border-2 border-[#a00000] bg-white p-4 shadow-[0_8px_0_rgba(160,0,0,0.10)]">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-[#a00000] bg-yellow-300 px-5 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#4a0000]"
                >
            ...
            <section id="inventario-conteo" className="scroll-mt-28 mt-4 rounded-[1.5rem] border-2 border-[#a00000] bg-white p-4 shadow-[0_8px_0_rgba(160,0,0,0.10)]">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.18em] text-[#a00000]">
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap lg:justify-end">
                  ...
                  {isPhysicalCountVisible && (
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-[#a00000] bg-white px-5 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#a00000] disabled:opacity-50"
                    >
                      <RefreshCw size={16} />
                      Preparar conteo
                    </button>
              ...
              {isPhysicalCountVisible && (
                <div className="mt-4 space-y-4">
                  ...
                  <div className="rounded-[1.3rem] border-2 border-yellow-400 bg-yellow-100 px-4 py-3 text-sm font-black leading-6 text-[#8a5a00]">
                  ...
                  <div className="grid gap-3 lg:grid-cols-[1fr_auto_auto]">
                    <input
                      ...
                      className="w-full rounded-2xl border-2 border-[#a00000]/25 bg-[#fff7e8] px-4 py-4 text-sm font-bold text-[#4a0000] outline-none placeholder:text-[#4a0000]/45 focus:border-[#a00000]"
                    />

                    <button
                      type="button"
                      onClick={() => setShowOnlyPhysicalCountDifferences((currentValue) => !currentValue)}
                      className="rounded-2xl border-2 border-[#a00000] bg-white px-5 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#a00000]"
                    >
                    ...
                    {visiblePhysicalCountRows.map((row) => {
                      ...
                      const differenceTone = row.difference > 0
                        ...
                        : row.difference < 0
                          ...
                          : "border-[#a00000]/15 bg-white text-[#3a0000]/65"

                      return (
                        <div
                          key={row.item.id}
                          className="rounded-[1.2rem] border-2 border-[#a00000]/20 bg-[#fff7e8] p-3"
                        >
                          <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                            <div>
                              <p className="text-[0.68rem] font-black uppercase tracking-[0.18em] text-[#a00000]">
                                {row.item.category}
                              </p>
                              <h3 className="mt-1 text-lg font-black uppercase text-[#a00000]">
                                {row.item.name}
                              </h3>
                          ...
                          <div className="mt-3 grid gap-3 sm:grid-cols-[1fr_auto]">
                            <input
                              ...
                              className="w-full rounded-2xl border-2 border-[#a00000]/25 bg-white px-4 py-3 text-base font-black text-[#4a0000] outline-none placeholder:text-[#4a0000]/40 focus:border-[#a00000]"
                            />

                            <button
                              type="button"
                              onClick={() => updatePhysicalCountValue(row.item.id, String(row.item.quantity || 0))}
                              className="rounded-2xl border-2 border-[#a00000] bg-white px-4 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#a00000]"
                            >
                              Igual
                            </button>
                          </div>
                  ...
                  {visiblePhysicalCountRows.length === 0 && (
                    <div className="rounded-[1.3rem] border-2 border-[#a00000]/15 bg-[#fff7e8] p-4 text-sm font-black text-[#3a0000]/65">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                    <button
                      ...
                      className="inline-flex min-h-[48px] w-full max-w-[320px] items-center justify-center gap-2 rounded-2xl border-2 border-[#a00000] bg-yellow-300 px-5 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#4a0000] disabled:opacity-50"
                    >
                      {isApplyingPhysicalCount ? <Loader2 size={18} className="animate-spin" /> : <CheckCircle2 size={18} />}
                      Aplicar conteo físico
                    </button>

                    <p className="max-w-2xl text-xs font-bold leading-5 text-[#3a0000]/60">
            ...
            <section id="inventario-recetas" className="scroll-mt-28 mt-4 rounded-[1.5rem] border-2 border-[#a00000] bg-white p-4 shadow-[0_8px_0_rgba(160,0,0,0.10)]">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.18em] text-[#a00000]">
                ...
                <div className="mt-4 grid gap-4 xl:grid-cols-[1fr_1.1fr]">
                  <div className="rounded-[1.4rem] border-2 border-[#a00000]/25 bg-[#fff7e8] p-4">
                    ...
                    <div className="mt-3 grid gap-3">
                      <div>
                        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                          ...
                          <button
                            ...
                            disabled={isLoading}
                            className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-[#a00000] bg-white px-3 py-2 text-[0.65rem] font-black uppercase tracking-[0.1em] text-[#a00000] disabled:opacity-50"
                          >
                      ...
                      <div className="rounded-[1.2rem] border-2 border-yellow-400 bg-yellow-100 px-4 py-3 text-sm font-black leading-6 text-[#8a5a00]">
                      ...
                      <div className="grid gap-3 sm:grid-cols-[1fr_140px_auto] sm:items-end">
                        <div>
                          ...
                          <input
                            ...
                            className="mt-2 w-full rounded-2xl border-2 border-[#a00000]/25 bg-white px-4 py-3 text-sm font-bold text-[#4a0000] outline-none focus:border-[#a00000]"
                          />
                          ...
                          {recipeAvailableInventory.length === 0 && (
                            <p className="mt-2 rounded-2xl border-2 border-[#a00000]/15 bg-white px-4 py-3 text-xs font-bold leading-5 text-[#3a0000]/65">
                        ...
                        <button
                          ...
                          className="inline-flex min-h-[48px] items-center justify-center gap-2 rounded-2xl border-2 border-[#a00000] bg-yellow-300 px-5 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#4a0000]"
                        >
                          <Plus size={16} />
                          Agregar insumo
                        </button>
                      ...
                      <div className="rounded-[1.2rem] border-2 border-[#a00000]/20 bg-white p-3">
                        <p className="text-xs font-black uppercase tracking-[0.18em] text-[#a00000]">
                          Insumos de esta receta
                        </p>

                        {recipeForm.ingredients.length === 0 ? (
                          <p className="mt-3 rounded-2xl bg-[#fff7e8] px-4 py-3 text-sm font-bold leading-6 text-[#3a0000]/65">
                          ...
                          <div className="mt-3 flex flex-wrap gap-2">
                            {recipeForm.ingredients.map((ingredient) => (
                              <span
                                ...
                                className="inline-flex items-center gap-2 rounded-full border-2 border-[#a00000]/20 bg-[#fff7e8] px-3 py-2 text-xs font-black text-[#4a0000]"
                              >
                      ...
                      <div className="flex flex-col gap-3 sm:flex-row">
                        <button
                          ...
                          className="inline-flex min-h-[46px] items-center justify-center gap-2 rounded-2xl border-2 border-[#a00000] bg-yellow-300 px-5 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#4a0000] disabled:opacity-50"
                        >
                        ...
                        <button
                          ...
                          disabled={isSavingRecipe}
                          className="min-h-[46px] rounded-2xl border-2 border-[#a00000] bg-white px-5 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#a00000] disabled:opacity-50"
                        >
                          Limpiar receta
                        </button>
                      </div>
                  ...
                  <div className="rounded-[1.4rem] border-2 border-[#a00000]/25 bg-white p-4">
                    ...
                    {inventoryRecipes.length === 0 ? (
                      <p className="mt-3 rounded-2xl bg-[#fff7e8] px-4 py-4 text-sm font-bold leading-6 text-[#3a0000]/70">
                      ...
                      <div className="mt-3 space-y-3">
                        {inventoryRecipes.map((recipe) => (
                          <article key={recipe.id} className="rounded-2xl border-2 border-[#a00000]/15 bg-[#fff7e8] p-4">
                            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                              <div>
                                <p className="text-[0.62rem] font-black uppercase tracking-[0.16em] text-[#a00000]">
                                  {recipe.productCategory || "Producto"}
                                </p>
                                <h3 className="mt-1 text-lg font-black uppercase text-[#220000]">
                                  {recipe.productName}
                                </h3>
                              </div>
                              ...
                              <div className="flex flex-wrap gap-2">
                                <button
                                  ...
                                  className="rounded-full border-2 border-[#a00000] bg-white px-4 py-2 text-xs font-black uppercase tracking-[0.12em] text-[#a00000]"
                                >
                                  Editar
                                </button>
                                <button
                            ...
                            <div className="mt-3 flex flex-wrap gap-2">
                              {recipe.ingredients.map((ingredient) => (
                                <span key={ingredient.itemId} className="rounded-full bg-white px-3 py-2 text-xs font-black text-[#4a0000]">
                                  {ingredient.itemName}: {ingredient.quantity} {ingredient.unit}
                                </span>
                              ))}
                            </div>
            ...
            <section id="inventario-nuevo" className="scroll-mt-28 mt-4 rounded-[1.5rem] border-2 border-[#a00000] bg-white p-4 shadow-[0_8px_0_rgba(160,0,0,0.10)]">
              ...
              {isFormVisible && (
                <div className="mt-4 grid gap-3 lg:grid-cols-2">
                  <div className="lg:col-span-2 rounded-[1.4rem] border-2 border-[#a00000]/25 bg-white p-4">
                    <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                      <div>
                        <p className="text-xs font-black uppercase tracking-[0.18em] text-[#a00000]">
                          Producto rápido
                    ...
                    <select
                      ...
                      className="mt-3 w-full rounded-2xl border-2 border-[#a00000]/25 bg-[#fff7e8] px-4 py-4 text-base font-bold text-[#4a0000] outline-none focus:border-[#a00000]"
                    >
                    ...
                    {areQuickItemsVisible && (
                      <div className="mt-4 rounded-[1.2rem] border-2 border-[#a00000]/15 bg-[#fff7e8] p-3">
                        <p className="text-xs font-black uppercase tracking-[0.18em] text-[#a00000]">
                        ...
                        <div className="mt-3 grid gap-2 lg:grid-cols-[1fr_170px_150px_auto]">
                          <input
                            ...
                            className="rounded-2xl border-2 border-[#a00000]/25 bg-white px-4 py-3 text-sm font-bold text-[#4a0000] outline-none focus:border-[#a00000]"
                          />
                          ...
                          <button
                            ...
                            className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-[#a00000] bg-yellow-300 px-4 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#4a0000]"
                          >
                            <Plus size={15} />
                            Agregar
                          </button>
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                          {quickInventoryItems.map((item) => (
                            <span
                              key={item.id}
                              className="inline-flex items-center gap-2 rounded-full border-2 border-[#a00000]/20 bg-white px-3 py-2 text-xs font-black text-[#4a0000]"
                            >
                              {item.name}
                              <button
                                type="button"
                        ...
                        <button
                          ...
                          className="mt-3 rounded-full border-2 border-[#a00000] bg-white px-4 py-2 text-xs font-black uppercase tracking-[0.12em] text-[#a00000]"
                        >
                  ...
                  <div className="lg:col-span-2 rounded-[1.4rem] border-2 border-[#a00000]/25 bg-white p-4">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      <div>
                        ...
                        {entryQuantityDelta > 0 && (
                          <p className="mt-2 rounded-2xl bg-[#fff7e8] px-3 py-2 text-xs font-black uppercase tracking-[0.08em] text-[#a00000]">
                    ...
                    {canRegisterExpenses && entryQuantityDelta <= 0 && (
                      <p className="mt-3 rounded-2xl border-2 border-[#a00000]/15 bg-[#fff7e8] px-4 py-3 text-xs font-bold leading-5 text-[#3a0000]/65">
                  ...
                  <div className="lg:col-span-2 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
                    <button
                      ...
                      onClick={saveItem}
                      disabled={isSaving}
                      className="inline-flex min-h-[48px] w-full max-w-[280px] items-center justify-center gap-2 rounded-2xl border-2 border-[#a00000] bg-yellow-300 px-5 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#4a0000] disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      onClick={resetForm}
                      disabled={isSaving}
                      className="min-h-[48px] w-full max-w-[280px] rounded-2xl border-2 border-[#a00000] bg-white px-5 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#a00000] disabled:opacity-50"
                    >
                      Limpiar formulario
                    </button>
                  </div>
            ...
            <section id="inventario-productos" className="scroll-mt-28 sticky top-0 z-30 mt-4 rounded-[1.4rem] border-2 border-[#a00000] bg-white p-3 shadow-[0_8px_0_rgba(160,0,0,0.10)]">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.18em] text-[#a00000]">
              ...
              {areInventoryFiltersVisible ? (
                <div className="mt-3 grid gap-3 lg:grid-cols-[1fr_auto_auto] lg:items-center">
                  ...
                  <select
                    ...
                    className="rounded-full border-2 border-[#a00000]/25 bg-white px-4 py-3 text-xs font-black uppercase tracking-[0.12em] text-[#a00000] outline-none focus:border-[#a00000]"
                  >
                ...
                <div className="mt-3 rounded-[1.1rem] border-2 border-[#a00000]/15 bg-[#fff7e8] px-4 py-3">
                  <p className="text-xs font-bold leading-5 text-[#3a0000]/70">
                    Filtros activos:
            ...
            <section id="inventario-historial" className="scroll-mt-28 mt-4 rounded-[1.4rem] border-2 border-[#a00000]/25 bg-white p-4 shadow-[0_8px_0_rgba(160,0,0,0.08)]">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.18em] text-[#a00000]">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {areMovementsVisible && (
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-[#a00000] bg-white px-4 py-2 text-xs font-black uppercase tracking-[0.12em] text-[#a00000]"
                    >
                      Copiar resumen
                    </button>
                  )}
              ...
              {areMovementsVisible ? (
                <div className="mt-4 space-y-4">
                  ...
                  <div className="rounded-[1.2rem] border-2 border-[#a00000]/15 bg-[#fff7e8] p-3">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      <div>
                        <p className="text-xs font-black uppercase tracking-[0.18em] text-[#a00000]">
                          Resumen por producto
                      ...
                      <button
                        ...
                        className="rounded-full border-2 border-[#a00000] bg-white px-4 py-2 text-[0.65rem] font-black uppercase tracking-[0.12em] text-[#a00000]"
                      >
                    ...
                    {isMovementProductSummaryVisible && (
                      <div className="mt-3 grid gap-2 lg:grid-cols-2 xl:grid-cols-3">
                        {movementProductSummary.length === 0 ? (
                          <p className="rounded-2xl bg-white px-4 py-3 text-xs font-bold leading-5 text-[#3a0000]/65">
                          ...
                          movementProductSummary.slice(0, 9).map((productSummary) => (
                            <div
                              ...
                              className="rounded-2xl border-2 border-[#a00000]/15 bg-white px-4 py-3"
                            >
                              <p className="text-sm font-black uppercase leading-tight text-[#220000]">
                                {productSummary.itemName}
                              </p>
                              <p className="mt-1 text-[0.65rem] font-black uppercase tracking-[0.1em] text-[#a00000]">
                              ...
                              <p className="mt-1 text-[0.68rem] font-bold text-[#3a0000]/55">
                  ...
                  {!areMovementFiltersVisible && (
                    <div className="flex flex-col gap-3 rounded-[1.2rem] border-2 border-[#a00000]/15 bg-[#fff7e8] px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
                      <p className="text-xs font-bold leading-5 text-[#3a0000]/70">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <button
                          ...
                          className="rounded-full border-2 border-[#a00000] bg-yellow-300 px-4 py-2 text-[0.65rem] font-black uppercase tracking-[0.12em] text-[#4a0000]"
                        >
                          Mostrar filtros
                        </button>
                      </div>
                  ...
                  {areMovementFiltersVisible && (
                    <div className="rounded-[1.3rem] border-2 border-[#a00000]/20 bg-[#fff7e8] p-3">
                      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                        <p className="text-xs font-black uppercase tracking-[0.18em] text-[#a00000]">
                      ...
                      <div className="mt-3 grid gap-3 xl:grid-cols-[1fr_180px_180px_180px_160px_160px]">
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full rounded-full border-2 border-[#a00000]/25 bg-white px-11 py-3 text-sm font-bold text-[#4a0000] outline-none placeholder:text-[#4a0000]/45 focus:border-[#a00000]"
                          />
                        </div>
                        ...
                        <select
                          ...
                          className="rounded-full border-2 border-[#a00000]/25 bg-white px-4 py-3 text-xs font-black uppercase tracking-[0.1em] text-[#a00000] outline-none focus:border-[#a00000]"
                        >
                  ...
                  {inventoryMovements.length === 0 ? (
                    <p className="rounded-2xl bg-[#fff7e8] px-4 py-4 text-sm font-bold leading-6 text-[#3a0000]/70">
                    ...
                    <p className="rounded-2xl border-2 border-yellow-400 bg-yellow-100 px-4 py-4 text-sm font-bold leading-6 text-[#8a5a00]">
                          ...
                          >
                            <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                              <div>
                                ...
                                <h3 className="mt-1 text-base font-black uppercase text-[#220000]">
                                  {movement.itemName}
                                </h3>
                            ...
                            {(movement.relatedExpense || movement.expenseId || movement.note) && (
                              <p className="mt-3 rounded-xl bg-white/70 px-3 py-2 text-xs font-bold leading-5 text-[#3a0000]/70">
            ...
            {activeInventoryModule === "productos" && (filteredInventory.length === 0 ? (
              <section className="mt-5 rounded-[2rem] border-2 border-[#a00000] bg-white px-6 py-14 text-center shadow-[0_8px_0_rgba(160,0,0,0.12)]">
                <PackageCheck className="mx-auto text-[#a00000]" size={54} />
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="space-y-4 p-4">
                        ...
                        {item.note && (
                          <div className="rounded-[1.2rem] border-2 border-[#a00000]/20 bg-[#fff7e8] p-3">
                            <p className="text-[0.62rem] font-black uppercase tracking-[0.16em] text-[#a00000]">
                              Nota
                            </p>
                        ...
                        <div className="grid gap-2 sm:grid-cols-2 xl:grid-cols-4">
                          <button
                            ...
                            className="inline-flex min-h-[44px] items-center justify-center gap-2 rounded-2xl border-2 border-[#a00000] bg-yellow-300 px-4 py-2.5 text-xs font-black uppercase tracking-[0.1em] text-[#4a0000]"
                          >
                            <Plus size={16} />
                            Entrada
                          </button>
                          ...
                          <button
                            type="button"
                            onClick={() => adjustItemQuantity(item, -1)}
                            className="min-h-[44px] rounded-2xl border-2 border-[#a00000] bg-white px-4 py-2.5 text-xs font-black uppercase tracking-[0.1em] text-[#a00000]"
                          >
                            Salida
                          </button>
  ...
  return (
    <button
      ...
      className={`flex min-h-[42px] w-full items-center justify-center rounded-2xl border-2 px-3 py-2 text-center text-[0.66rem] font-black uppercase leading-tight tracking-[0.1em] transition ${
        active
          ? "border-[#a00000] bg-yellow-300 text-[#4a0000] shadow-[0_4px_0_rgba(160,0,0,0.16)]"
          : "border-[#a00000]/35 bg-[#fff7e8] text-[#a00000] hover:border-[#a00000] hover:bg-yellow-100"
      }`}
    >
      {label}
    </button>
...
function MovementSummaryBox({
  ...
  return (
    <div className="rounded-[1.1rem] border-2 border-[#a00000]/20 bg-[#fff7e8] px-4 py-3">
      <p className="text-[0.6rem] font-black uppercase tracking-[0.16em] text-[#a00000]">
        {label}
      </p>
      <p className="mt-1 text-lg font-black text-[#220000]">{value}</p>
    </div>
  )
}
