...
export async function GET() {
  try {
    ...
    const deliveryZones = await getDeliveryZonesFromAppsScript()
...
export async function POST(request: NextRequest) {
  try {
    ...
    const savedDeliveryZones = await saveDeliveryZonesInAppsScript(deliveryZones)
