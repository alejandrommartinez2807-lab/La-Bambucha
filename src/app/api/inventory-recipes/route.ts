...
import {
  deleteInventoryRecipeInAppsScript,
  getBusinessConfigFromAppsScript,
  getInventoryRecipesFromAppsScript,
  saveInventoryRecipeInAppsScript,
...
export async function GET(request: NextRequest) {
  try {
    ...
    const inventoryRecipes = await getInventoryRecipesFromAppsScript()
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await saveInventoryRecipeInAppsScript(recipeInput)
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    const result = await deleteInventoryRecipeInAppsScript(recipeId)
