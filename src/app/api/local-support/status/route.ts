// DESTINO REAL: src/app/api/local-support/status/route.ts
...
export async function GET(request: NextRequest) {
  try {
    ...
    const [
      ...
      safeCheck("Configuración del negocio", () => getBusinessConfigFromAppsScript()),
      safeCheck("Pedidos", () => getOrdersFromAppsScript()),
      safeCheck("Zonas de delivery", () => getDeliveryZonesFromAppsScript()),
      safeCheck("Cierres guardados", () => getDayClosesFromAppsScript()),
    ...
    return NextResponse.json({
      ...
      business: {
        name: String(businessConfig?.businessName || "Santo Perrito"),
        description: String(
